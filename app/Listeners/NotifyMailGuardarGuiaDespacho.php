            ...
            <table id='factura_detalle'>
                <thead>
                    <tr>
                        ...
                        <th width='50px' style='text-align: center;' title='Cant. Solicitud Despacho'>SolDesp</th>
                ...
                foreach ($dte->dtedets as $dtedet) {
                    $dtedets[$dtedet->dtedet_despachoorddet->notaventadetalle_id] = [
                        "despachosol_cant" => $dtedet->dtedet_despachoorddet->despachoorddet->despachosoldet->cantsoldesp,
                ...
                foreach ($notaventadetalles as $notaventadetalle) {
                    ...
                    "<tr class='headt' style='height:150%;'>
                        ...
                        <td style='text-align: center;' title='$group_guiadespacho'>$sumacantdespPrev</td>
                        <td style='text-align: center;'>$aux_despachosol_cant</td>
