...
class NotifyMailFactxVencer
{
    ...
    {
        $aux_email = "gmoreno@gmail.com";
        $facturas = $event->facturas;
        $asunto = "Facturas por Vencer en 10 Días";
        if(count($facturas) <= 0){
            $aux_cuerpo = 
            "
            Estimado/a [Nombre del Usuario],\n\nNos complace informarle que actualmente no tiene ninguna factura pendiente de vencimiento en los próximos 10 días en la sucursal {$sucursal}.\n\nGracias por su atención.\n\nAtentamente,\n[Nombre de la Empresa]
            <br>
            <span class='h3'>NO HAY INFORMACION PARA MOSTRAR</span>
            <br>";
        }else{
            $aux_cuerpo = 
            "
