...
*/
    ...
    $sql = "SELECT despachosol.id,despachosol.fechahora,notaventa.cliente_id,cliente.rut,cliente.razonsocial,notaventa.oc_id,
            ...
            and despachosol.id not in (SELECT despachosol_id FROM despachosolenvorddesp where despachosolenvorddesp.despachosol_id = despachosol.id AND ISNULL(despachosolenvorddesp.deleted_at))
