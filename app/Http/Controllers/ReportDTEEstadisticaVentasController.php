...
class ReportDTEEstadisticaVentasController extends Controller
{
    /**
    ...
    {
        can('listar-reporte-dte-estadistica-venta');
        $fechaAct = date("d/m/Y");
    ...
    public function reportdteestadisticaventapage(Request $request){
    ...
    public function exportPdf(Request $request)
    {
        ...
        if($datas){
            ...
            if(env('APP_DEBUG')){
                return view('reportdteestadisticaventa.listado', compact('datas','empresa','usuario','request'));
            }
            ...
            $pdf = PDF::loadView('reportdteestadisticaventa.listado', compact('datas','empresa','usuario','request'));
