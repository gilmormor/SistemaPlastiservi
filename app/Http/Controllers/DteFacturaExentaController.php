...
class DteFacturaExentaController extends Controller
{
    ...
    public function guardar(Request $request)
    {
        ...
        $request1->merge(['modulo_id' => 17]);
        $request1->request->set('modulo_id', 17);
...
function consultaindex($dte_id){
    ...
    ON clientedesbloqueadomodulo.clientedesbloqueado_id = clientedesbloqueado.id and clientedesbloqueadomodulo.modulo_id = 18
    LEFT JOIN modulo
