...
use App\Http\Requests\ValidarDTENdNcEditar;
...
class DteNdNcEditarController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $tablashtml['sucursales'] = Sucursal::orderBy('id')
                        ...
                        ->get();
        return view('dtendnceditar.index', compact('giros','areaproduccions','tipoentregas','fechaAct','tablashtml'));
    }

    public function dtendnceditarpage(Request $request){
        //dd($request);
        $request->request->add(['foliocontrol_id' => '5,6']);
    ...
    //dd($sql);
        ...
        return view('dtendnceditar.editar', compact('data','tablas'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function actualizar(ValidarDTENdNcEditar $request, $id)
    {
        can('guardar-dte-ndnc-editar');
        ...
        return redirect('dtendnceditar')->with('mensaje','Actualizado con exito.');
    }
}
