        ...
        if ($request->ajax()) {
            ...
            try {
                ...
                foreach ($request->EtapasProduccion as $EtapasProduccion) {
                    ...
                    $produccion->cantrec = 0; //$otdet->cantprod;
                    $produccion->kgrec = 0; //$otdet->kgprod;
                    $produccion->cantprod = 0;
                    $produccion->kgprod = 0;
                    ...
                    /* if($i == 0){
                        //Si es el proceso inicial se crea el registro en produccion y producciondet
