            ...
            if ($despachoord->save()) {
                ...
                <td class='info_factura'>
                    <div>
                        ...
                        <p>Solicitud de Despacho Nro: <strong> $aux_orddespnro</strong></p>
                        <p>Fecha Actual: $datehoy</p>
                        <p>Fecha SolDesp: $dateOrdDesp</p>
                    ...
                    <table id='factura_detalle'>
                        ...
                        foreach ($despachoord->despachoorddets as $despachoorddet) {
                            ...
                            $sql = "SELECT cantdesp
                                    ...
                                    WHERE despachosoldet_id=$despachoorddet->despachosoldet_id";
                            $datasuma = DB::select($sql);
                            if(empty($datasuma)){
                                $sumacantorddesp= 0;
                            }else{
                            ...
                            */
                            ...
                            /*
                            $aux_cantSolPrev = $sumacantorddesp - $aux_cantOD;
                            $aux_saldoNV = $aux_cantNV - $sumacantorddesp;
                            */
                            $aux_despOrddet .=
