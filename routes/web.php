...
//COMANDO PARA ENVIAR CORREO DE FACTURAS POR VENCER 
Route::get('enviaremailfxv',function(){
    Artisan::call('datacobranza:enviaremailfxv');
});
...
Route::get('ciudadpage', 'CiudadController@ciudadpage')->name('ciudadpage');
...
Route::get('comunapage', 'ComunaController@comunapage')->name('comunapage');
...
Route::get('areaproduccionsucfase', 'AreaProduccionSucFaseController@index')->name('areaproduccionsucfase');
Route::get('areaproduccionsucfasepage', 'AreaProduccionSucFaseController@areaproduccionsucfasepage')->name('areaproduccionsucfasepage');
Route::post('areaproduccionsucfase/guardar', 'AreaProduccionSucFaseController@guardar')->name('guardar_areaproduccionsucfase');
Route::get('areaproduccionsucfase/{id}/editar', 'AreaProduccionSucFaseController@editar')->name('editar_areaproduccionsucfase');
Route::put('areaproduccionsucfase/{id}', 'AreaProduccionSucFaseController@actualizar')->name('actualizar_areaproduccionsucfase');
