...
function exportarExcel() {
    ...
    $.ajax({
        url: "reportinvstockbppage/" + data.data2, // ajusta la URL de la solicitud al endpoint correcto
        type: 'POST',
        dataType: 'json',
        ...
        datosExcel.push(["Stock Picking","","","","","","","","","",fechaactual()]);
        datosExcel.push(["Fecha: " + aux_mesanno,"","","","","","","",""]);
        aux_totalStock = 0;
        datosExcel.push(["","","","","","","","",""]);
        datosExcel.push(["Cod","Producto","Categoria","Clase/Sello","Diam/Ancho","L","Peso/Esp","TU","Bodega","Picking","Stock"]);
        data.data.forEach(function(registro) {
            ...
            var filaExcel = [
                ...
                registro.peso,
                registro.tipounion,
                registro.stockBodProdTerm,
                registro.stockPiking,
                registro.stock,
            ];
            count++;
...
function createExcel(datosExcel) {
    ...
    */
    ...
    workbook.xlsx.writeBuffer().then(function(buffer) {
      ...
      a.href = url;
      a.download = "invstockpicking.xlsx";
      a.click();
