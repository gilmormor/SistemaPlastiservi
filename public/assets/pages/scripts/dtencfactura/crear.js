	...
	for (i = 0; i < data.length; i++) {
		htmlTags = '<tr name="fila' + data[i].id + '" id="fila' + data[i].id + '" class="proditems ' + data[i].nrodocto + '">' +
			'<td style="text-align:center">' +
				...
				'<input type="text" name="dte_id[]" id="dte_id' + data[i].id + '" class="form-control" value="' + $("#dte_id").val() + '" style="display:none;"/>' +
			...
			'<td name="cantTD' + data[i].id + '" id="cantTD' + data[i].id + '" style="text-align:right" class="subtotalcant" valor="' + data[i].qtyitem + '">' +
				'<input type="text" name="qtyitem[]" id="qtyitem' + data[i].id + '" class="form-control numerico" value="' + data[i].qtyitem + '" valor="' + data[i].qtyitem + '" valorini="' + data[i].qtyitem + '"style="text-align:right" onkeyup="calsubtotalitem(' + data[i].id + ')"/>' +
			'</td>' +
			...
			'<td name="preciounitTD' + data[i].id + '" id="preciounitTD' + data[i].id + '" style="text-align:right;">' +
				'<input type="text" name="prcitem[]" id="prcitem' + data[i].id + '" class="form-control numerico" value="' + data[i].prcitem + '" valor="' + data[i].prcitem + '" valorini="' + data[i].prcitem + '" style="text-align:right" onkeyup="calsubtotalitem(' + data[i].id + ')"/>' +
			'</td>' +
			...
			'<td name="subtotalFactDet' + data[i].id + '" id="subtotalFactDet' + data[i].id + '" class="subtotalFactDet" style="text-align:right">' +
				'<input type="text" name="montoitem[]" id="montoitem' + data[i].id + '" class="form-control numerico" value="' + data[i].montoitem + '" valor="' + data[i].montoitem + '" valorini="' + data[i].montoitem + '" style="text-align:right" onkeyup="calpreciounit(' + data[i].id + ')"/>' +
			'</td>' +
...
function llenarTadosCliente(respuesta){
	$("#rut").val(respuesta.cliente[0].rut);
	...
	$('#centroeconomico_id').val(respuesta.cliente[0].centroeconomico_id); // Select the option with a value of '1'
	$('#vendedor_id').val(respuesta.cliente[0].vendedor_id); // Select the option with a value of '1'
	$('.select2').trigger('change');

	$("#hep").val(respuesta.cliente[0].hep);
	$("#obs").val(respuesta.cliente[0].obs);
}
...
function respableservaloresini(i){
