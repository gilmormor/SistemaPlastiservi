...
$("#permisoT").click(function(event)
{
    if($("#permisoT").prop("checked")){
		$("#permiso").val('1');
        $("#358id24").prop("checked", true);
        $("#359id24").prop("checked", true);
        $("#361id24").prop("checked", true);
	}else{
		$("#permiso").val('0');
		$("#358id24").prop("checked", false);
		$("#359id24").prop("checked", false);
		$("#361id24").prop("checked", false);
	}
    ...
    permiso_rol("358id24",358,24)
    permiso_rol("359id24",359,24)
    permiso_rol("361id24",361,24)
