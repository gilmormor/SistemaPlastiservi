...
*/
            ...
            if(data.clientebloqueado_descripcion != null){
                aux_text = 
                    "<a style='padding-left: 0px;' class='btn-accion-tabla btn-sm tooltipsC' title='Condición financiera en revisión: " + data.clientebloqueado_descripcion + "'>"+
...
*/
            ...
            $('td',row).eq(16).attr('stasubsii',stasubsii_text);
            ...
            $('td',row).eq(16).attr('stasubcob',stasubcob_text);
            bntaproord_text = 
            `<a ${aux_displaybtnac} id="bntaproord${data.id}" name="bntaproord${data.id}" class="btn-accion-tabla btn-sm tooltipsC botonac${data.id}" onclick="procesarDTE(${data.id},12)" title="Enviar a procesados">
                <span class="glyphicon glyphicon-floppy-save" style="bottom: 0px;top: 2px;"></span>
            </a>`;
            $('td',row).eq(16).attr('bntaproord',bntaproord_text);
            aux_text = '';
