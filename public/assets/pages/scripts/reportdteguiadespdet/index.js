    ...
    $('#tabla-data-consulta').DataTable({
        ...
        "createdRow": function ( row, data, index ) {
            ...
            if (data.dteanul_obs != null) {
                ...
                aux_text = data.id +
                "<a class='btn-accion-tabla tooltipsC' title='Anulada " + fechaddmmaaaa(aux_fecha) + " Obs: " + data.dteanul_obs + "'>" +
            ...
            if(data.fact_nrodocto != null){
                ...
                if(data.fact_nrodocto != null){
                    ...
                    <a style="padding-left: 0px;" class="btn-accion-tabla btn-sm tooltipsC" title="Cedible:${data.fact_nrodocto}" onclick="genpdfFACDin('${data.fact_dte_id}',1)">
                        <i class="fa fa-fw fa-file-pdf-o"></i>
                    </a>`;
                }
            }
...
function exportarExcelSantaEster() {
    ...
    $.ajax({
      url: "/reportdteguiadespdet/reportdteguiadespdetpage/" + data.data2, // ajusta la URL de la solicitud al endpoint correcto
      type: 'POST',
      dataType: 'json',
