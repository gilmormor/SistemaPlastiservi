...
function configurarTabla(nombreTabla,url,serverSide) {
    ...
    tabla = $(nombreTabla).DataTable({
        ...
        'columnDefs'  : [
            ...
            { targets: 6 , width: '55px' },
            { targets: 7 , width: '50px' },
            { targets: 8 , width: '130px' },
            { targets: 9 , width: '50px' },
            { targets: 10, width: '68px' },
            { targets: 12, width: '70px' },
            { targets: 13, width: '75px' },
            { targets: 14, width: '75px' },
            { targets: 15, width: '75px' },
            { targets: 16, width: '78px' },
            { targets: 17, width: '90px' },
            { targets: 18, width: '85px' },
            { targets: 19, width: '125px' },
            { targets: 20, width: '100px' },
            { targets: 21, width: '90px' },
        ],
        'processing'  : true,
