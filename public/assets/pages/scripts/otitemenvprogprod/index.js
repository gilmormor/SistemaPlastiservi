...
function configurarTabla(nombreTabla,url,serverSide) {
    ...
    tabla = $(nombreTabla).DataTable({
        ...
        "createdRow": function ( row, data, index ) {
            ...
            aux_text = 
                `<input type="text" name="espesorprod[]" id="espesorprod${data.id}" class="form-control numerico3d" value="${MASKLA(data.espesorprod,3)}" valor="${data.espesorprod}" item="${data.id}" style="width: 70px;text-align:right;" maxlength="6"/>`;
            ...
            aux_text = 
                `<input type="text" name="cantprod[]" id="cantprod${data.id}" class="form-control numerico" value="${MASKLA(data.cantprod,2)}" valor="${data.cantprod}" item="${data.id}" style="width: 100px;text-align:right;" maxlength="15"/>`;
