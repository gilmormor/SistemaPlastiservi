$(document).ready(function () {
    ...
    $('#tabla-data-dteguiadespacho').DataTable({
        ...
        "createdRow": function ( row, data, index ) {
            ...
            bntaproord_text = 
            `<a ${aux_displaybtnac} id="bntaproord${data.id}" name="bntaproord${data.id}" class="btn-accion-tabla btn-sm tooltipsC" onclick="procesarDTEGuiaDesp(${data.id})" title="Enviar a procesados">
            ...
            aux_text = 
                    `<a ${aux_displaybtnbl} class="btn-accion-tabla btn-sm tooltipsC" title="Cliente Bloqueado: ${aux_clienteBloqueado}" onclick="llenartablaDataCobranza(${data.id},${data.cliente_id},${data.notaventa_id})">
