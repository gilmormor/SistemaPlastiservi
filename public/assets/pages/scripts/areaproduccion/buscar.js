$(document).ready(function () {
    ...
    configurarTabla(nombreTabla,"areaproduccionetapaprodpage/?areaproduccion_id=0",false)
...
function saveordenetapaprod(id,updatednum_at){
    swal({
        ...
        if (value) {
            ...
            var ruta = '/areaproduccion/guardarordenetapaprod'; //Guardar Fecha estimada de despacho
