...
function pdfjs(datos) {
    ...
    doc.autoTable({
      ...
      willDrawPage: function (data) {
        ...
        doc.setFontSize(8)
        doc.text('Sucursal: ' + $("#sucursal_id option:selected").html(), data.settings.margin.left + 120, 20);
        ...
        doc.text('Giro: ' + $("#giro_id option:selected").html() + ' Estatus: ' + $("#aprobstatus option:selected").html(), data.settings.margin.left + 220, 18);
        doc.text('Nota Venta Desde: ' + $("#fechad").val() + " al " + $("#fechah").val(), data.settings.margin.left + 220, 21);
