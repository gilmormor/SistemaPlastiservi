                ...
                <div class="row">
                    <div class="col-xs-12 col-md-9 col-sm-12">
                        <div class="col-xs-12 col-md-12 col-sm-12">
                            ...
                            <div class="col-xs-12 col-md-12 col-sm-12">
                                <div class="col-xs-12 col-sm-6" classorig="col-xs-12 col-sm-6" title="Acuerdo tecnico Firmado">
                                    <div class="col-xs-12 col-md-4 col-sm-4 text-left">
                                        <label>At Firmado:</label>
                                    </div>
                                    <div class="col-xs-12 col-md-8 col-sm-8">
                                        <select name="at_firmadosta" id="at_firmadosta"  class="selectpicker form-control impreso form_acutec valorrequerido" tipoval="combobox">
                                ...
                                <div class="col-xs-12 col-sm-6" classorig="col-xs-12 col-sm-6" title="Acuerdo Tecnico Firmado Eliminado Pendiente por subir ">
                                    <div class="col-xs-12 col-md-4 col-sm-4 text-left">
                                        <label>At Firmado Eliminado:</label>
                                    </div>
                                    <div class="col-xs-12 col-md-8 col-sm-8">
                                        <select name="at_impresostaeli" id="at_impresostaeli"  class="selectpicker form-control impreso form_acutec valorrequerido" tipoval="combobox">
                                            <option value="">Seleccione...</option>
                                            <option value="1">Si</option>
                                        </select>
                                    </div>
