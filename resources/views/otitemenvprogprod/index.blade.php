...
@section('contenido')
<style>
    /* font-size definido aquí en CSS para que el <thead> ya tenga el tamaño correcto
       desde que se renderiza, sin depender del evento draw de DataTables (evita el salto visual). */
    #tabla-data-factura th,
    #tabla-data-factura td {
        font-size: 12px;
    }
    table td {
