		...
		<tr>
			...
			<td class="info_factura">
				<div>
					...
					<p>Fecha OD:  {{date('d-m-Y h:i:s A', strtotime($despachoord->fechahora))}}</p>
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th width="40px" class="textright">Despachado</th>
			...
			<tbody id="detalle_productos">
				...
				@foreach($despachoorddets as $despachoorddet)
					<?php
						...
						$aux_producto_nombre = $despachoorddet->notaventadetalle->producto->glosa;
					?>
