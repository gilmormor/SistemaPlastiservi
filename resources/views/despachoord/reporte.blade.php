	...
	<div>
		<table id="factura_detalle">
			...
			<tr class="headt">
				...
				<td class="textright" width="10%"><span><strong>{{number_format(round(($neto * $despachoord->notaventa->piva)/100), 2, ",", ".")}}</strong></span></td>
			</tr>
			<tr class="headt">
				<td colspan="7" class="textright" width="90%"><span><strong>TOTAL</strong></span></td>
				<td class="textright" width="10%"><span><strong>{{number_format(round($neto * ($despachoord->notaventa->piva+100)/100), 2, ",", ".")}}</strong></span></td>
			</tr>
		</table>
	</div>
	<br>
