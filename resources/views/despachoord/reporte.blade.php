...
<div id="page_pdf">
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th style="display:none;" class="textleft">Clase</th>
					<th style="display:none;" class="textleft">Diam</th>
					<th style="display:none;" class="textright">Largo</th>
					<th style="display:none;" class="textcenter">TU</th>
					<th width="30px" class="textright">Peso</th>
					<!--<th class="textright">$ x Kg</th>-->
					<th class="textright" width="60px">Total Kg</th>
			...
			<tbody id="detalle_productos">
				...
				@foreach($despachoorddets as $despachoorddet)
					<?php
						...
						$aux_cla_sello_nombre = isset($despachoorddet->notaventadetalle->producto->claseprod) ? $despachoorddet->notaventadetalle->producto->claseprod->cla_nombre : "";
					...
					<tr class="headt" style="height:150%;">
						...
						<td style="display:none;" class="textright">{{$aux_largo}}</td>
	...
	<div>
		<table id="factura_detalle">
			...
			<tr class="headt">
				<td colspan="3" class="textright" width="90%"><span><strong>IVA {{$despachoord->notaventa->piva}}%</strong></span></td>
			...
			<tr class="headt">
				<td colspan="3" class="textright" width="90%"><span><strong>TOTAL {{$datosArray["modena_desc"]}}</strong></span></td>
