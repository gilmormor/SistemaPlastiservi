...
<div id="page_pdf">
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th width="25px">Sol</th>
					<th width="20px" class="textcenter">UN</th>
					<th width="150px" class="textleft">Descripción</th>
					<th style="display:none;" width="40px" class="textcenter">Sello</th>
					<th style="display:none;" width="20px" class="textcenter">Ancho</th>
					<th style="display:none;" width="20px" class="textcenter">Largo</th>
					<th style="display:none;" width="20px" class="textcenter">Esp</th>
			...
			<tbody id="detalle_productos">
				...
				@foreach($despachoorddets as $despachoorddet)
					<?php
						...
						$atributoProd = $despachoorddet->notaventadetalle->producto->atributosProducto($despachoorddet->notaventadetalle->producto_id,$despachoorddet->notaventadetalle->cotizaciondetalle_id);
					...
					<tr class="headt" style="height:150%;">
						...
						<td style="display:none;" class="textcenter">{{$aux_cla_sello_nombre}}</td>
						<td style="display:none;" class="textcenter">{{$aux_ancho}}</td>
						<td style="display:none;" class="textcenter">{{$aux_largo}}</td>
						<td style="display:none;" class="textcenter">{{$aux_espesor}}</td>
			...
			<tfoot>
				<tr class="headt">
					<td colspan="6" class="textright" width="90%"><span><strong>NETO</strong></span></td>
					<td class="textright" width="10%"><span><strong>{{number_format($neto, $datosArray["monedaLocal"] ? 0 : 3, ",", ".")}}</strong></span></td>
				</tr>
				<tr class="headt">
					<td colspan="6" class="textright" width="90%"><span><strong>IVA {{$despachoord->notaventa->piva}}%</strong></span></td>
				...
				<tr class="headt">
					<td colspan="6" class="textright" width="90%"><span><strong>TOTAL {{$datosArray["modena_desc"]}}</strong></span></td>
	...
	<div class="round1">
		...
		<table id="factura_detalle">
			...
			<tr>
				<td colspan="3" class="textleft" width="40%"><span><strong>Solicitud de Despacho: </strong></span></td>
				<td class="textleft" width="50%"><span>{{str_pad($despachoord->despachosol_id, 10, "0", STR_PAD_LEFT)}}</span></td>
			</tr>
			<tr>
				<td colspan="3" class="textleft" width="40%"><span><strong>Guia Despacho: </strong></span></td>
				<td class="textleft" width="50%"><span>{{str_pad($despachoord->guiadespacho , 10, "0", STR_PAD_LEFT)}}</span></td>
			</tr>
			<tr>
				<td colspan="3" class="textleft" width="40%"><span><strong>Nro Factura: </strong></span></td>
