...
<div class="form-group">
    ...
    <div class="col-lg-5">
        ...
        <input type="file" name="foto_up" id="foto" data-initial-preview="{{isset($data->imagen) ? "/storage/imagenes/usuario/$data->imagen" : "http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=Foto+Usuario"}}" accept="image/*"/>
    </div>
</div>
<div class="form-group">
