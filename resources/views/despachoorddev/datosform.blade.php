<div class="row">
    ...
    <div class="form-group col-xs-12 col-sm-3">
        ...
        <input type="text" name="rut" id="rut" class="form-control" value="{{old('rut', $data->notaventa->cliente->rut ?? '')}}" maxlength="12" required readonly/>
    </div>
    <div class="form-group col-xs-12 col-sm-6">
        <label for="razonsocial" class="control-label" data-toggle='tooltip' title="Razón Social">Razón Social</label>
        <input type="text" name="razonsocial" id="razonsocial" class="form-control" value="{{old('razonsocial', $data->notaventa->cliente->razonsocial ?? '')}}" readonly/>
    </div>

    <div class="form-group col-xs-12 col-sm-2">
        <label for="fechahora" class="control-label">Fecha</label>
        <input type="text" name="fechahora" id="fechahora" class="form-control" value="{{old('fechahora', $fecha ?? '')}}" required readonly/>
    </div>
</div>
<div class="row">
    ...
    <div class="form-group col-xs-12 col-sm-2">
        ...
        <input type="text" name="comuna_nombreD" id="comuna_nombreD" class="form-control" value="{{old('comuna_nombreD', $data->notaventa->cliente->comuna->nombre ?? '')}}" required readonly/>
    </div>
...
<div class="row">
    <div class="form-group col-xs-12 col-sm-2">
        ...
        <input type="text" name="vendedor_nombreD" id="vendedor_nombreD" class="form-control" value="{{old('vendedor_nombreD', ($data->notaventa->vendedor->persona->nombre . " " . $data->notaventa->vendedor->persona->apellido) ?? '')}}" required readonly/>
    </div>
    <!--
    <div class="form-group col-xs-12 col-sm-2">
    ...
    <div class="form-group col-xs-12 col-sm-3">
        ...
        <input type="text" name="lugarentrega" id="lugarentrega" class="form-control" value="{{old('lugarentrega', $data->lugarentrega ?? '')}}" required placeholder="Lugar de Entrega" readonly required/>
    </div>
    <div class="form-group col-xs-12 col-sm-2">
        <label for="comunaentrega_id" class="control-label">Comuna Entrega</label>
        <input type="text" name="comunaentrega_nombre" id="comunaentrega_nombre" class="form-control" value="{{old('comunaentrega_nombre', $data->notaventa->comunaentrega->nombre ?? '')}}" readonly required/>
    </div>
   
    <div class="form-group col-xs-12 col-sm-3">
        <label for="contacto" class="control-label">Contacto</label>
        <input type="text" name="contacto" id="contacto" class="form-control" value="{{old('contacto', $data->contacto ?? '')}}" required placeholder="Contacto Entrega" readonly required/>
    </div>
    <div class="form-group col-xs-12 col-sm-2">
        <label for="contactotelf" class="control-label">Teléfono</label>
        <input type="text" name="contactotelf" id="contactotelf" class="form-control" value="{{old('contactotelf', $data->contactotelf ?? '')}}" required placeholder="Teléfono Contacto Entrega"  readonly required/>
    </div>
...
<div class="row">
    <div class="form-group col-xs-12 col-sm-4">
        ...
        <input type="email" name="contactoemail" id="contactoemail" class="form-control" value="{{old('contactoemail', $data->contactoemail ?? '')}}" required placeholder="Email Contacto Entrega" readonly required/>
    </div>
    <div class="form-group col-xs-12 col-sm-4">
        <label for="observacion" class="control-label">Observaciones</label>
        <input type="text" name="observacion" id="observacion" class="form-control" value="{{old('observacion', $data->observacion ?? '')}}" placeholder="Observaciones" readonly/>
    </div>
    <div class="form-group col-xs-12 col-sm-2">
    ...
    <div class="form-group col-xs-12 col-sm-2">
        ...
        <input type="text" name="despachoobs_nombre" id="despachoobs_nombre" class="form-control pull-right" value="{{old('despachoobs_nombre', $data->notaventa->despachoobs->nombre ?? '')}}" readonly/>
    </div>
</div>

<div class="row">
    <div class="form-group col-xs-12 col-sm-2">
        <label for="despachoorddevmotivo_idD" class="control-label requerido">Motivo Devolución</label>
        <select name="despachoorddevmotivo_id" id="despachoorddevmotivo_id" class="form-control select2" data-live-search='true' required>
            <option value="">Seleccione...</option>
            @foreach($despachoorddevmotivos as $despachoorddevmotivo)
                <option
                    value="{{$despachoorddevmotivo->id}}"
                    @if (($aux_sta==3) and $despachoorddevmotivo->id==$despachoorddev->despachoorddevmotivo_id)
                        {{'selected'}}
                    @endif
                    >
                    {{$despachoorddevmotivo->nombre}}
                </option>
            @endforeach
        </select>
    </div>
    <div class="form-group col-xs-12 col-sm-6">
        ...
        <input type="text" name="obs" id="obs" class="form-control pull-right" value="{{old('obs', $despachoorddev->obs ?? '')}}"/>
    </div>
</div>