                            ...
                            @foreach($detalles as $detalle)
                                ...
                                <tr name="fila{{$aux_nfila}}" id="fila{{$aux_nfila}}">
                                    ...
                                    <td name="totalkilosTD{{$aux_nfila}}" id="totalkilosTD{{$aux_nfila}}" style="text-align:right" class="subtotalkg" valor="0.00">
                                        <input type="text" name="itemkg[]" id="itemkg{{$aux_nfila}}" class="form-control numerico itemkgotnv" value="{{number_format($aux_totalkilos, 2, ',', '.')}}" valor="{{$aux_totalkilos}}" item="{{$aux_nfila}}" style="text-align:right" title="Kilos" maxlength="7"/>
