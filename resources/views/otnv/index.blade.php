...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/otnv/index.js")}}" type="text/javascript"></script>
@endsection
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{route('listarnv_otnv')}}" class="btn btn-block btn-success btn-sm">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table display AllDataTables table-condensed table-hover" id="tabla-data-otnv" data-page-length='50'>
                        <thead>
                            <tr>
                                <th class="width70" title='OT'>ID</th>
                                <th title='Fecha'>Fecha</th>
                                <th>Razón Social</th>
                                <th title='Orden de Compra'>OC</th>
                                <th title='Nota de Venta'>NV</th>
                                <th title='Precio x Kg'>$ x Kg</th>
                                <th title='Comuna'>Comuna</th>
                                <th title='Total Kg' style="text-align:right">Total Kg</th>
