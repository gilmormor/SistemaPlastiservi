...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/otnv/listarnotaventa.js")}}" type="text/javascript"></script>
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary collapsed-box">
            <div class="box-header with-border">
                <h3 class="box-title">Pendientes OT</h3>
            ...
            <div class="box-body">
                <div class="row">
                    <form action="{{route('exportPdf_notaventaconsulta')}}" class="d-inline form-eliminar" method="get" target="_blank">
                        ...
                        {{-- <input type="hidden" name="aux_ruta_crearot" id="aux_ruta_crearot" value="{{route('crear_ot', ['id' => "0",'updatenum_at' => "0"])}}"> --}}
