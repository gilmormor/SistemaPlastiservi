                        ...
                        <div class="col-xs-12 col-md-9 col-sm-12">
                            ...
                            <div class="col-xs-12 col-md-12 col-sm-12">
                                ...
                                <div class="col-xs-12 col-sm-6" data-toggle='tooltip' title="Orden de Compra">
                                    ...
                                    <div class="col-xs-12 col-md-8 col-sm-8">
                                        <input type="text" name="oc_id" id="oc_id" class="form-control validar-texto-xml" value="{{old('oc_id')}}" maxlength="18"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12 col-sm-12">
                ...
                <table id='tabla-data-consulta' name='tabla-data-consulta' class='table display AllDataTables table-hover table-condensed tablascons2' data-page-length='10'>
                    <thead>
                        <tr>
                            ...
                            <th>Comuna</th>
                            <th>LugarEntrega</th>
                            <th title='Tipo de entrega'>TipoEntrega</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="16" style="text-align:right">TOTALES</th>
                        ...
                        <tr>
                            <th colspan="16" style="text-align:right">PROMEDIO</th>
