...
<div id="page_pdf">
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th width="25px" class="textright">Peso</th>
					<!--<th class="textright">$ x Kg</th>-->
					<th width="30px" class="textright">Total Kg</th>
					<th width="40px" class="textright" width="60px">Precio Unit {{$datosArray["modena_desc"]}}</th>
					<th width="60px" class="textright" width="70px">Total Neto {{$datosArray["modena_desc"]}}</th>
				</tr>
			</thead>
			...
			<tfoot>
				<tr>
					<td colspan="6" class="textright"><span><strong>Totales {{$datosArray["modena_desc"]}}</strong></span></td>
	...
	<div>
		<table id="factura_detalle">
			...
			<tr class="headt">
				<td colspan="3" class="textright" width="90%"><span><strong>IVA {{$despachosol->notaventa->piva}}%</strong></span></td>
