...
@section('titulo')
Precio promedio NV Agrupado x Categoria
@endsection
...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/reportgrupocatprom/index.js")}}" type="text/javascript"></script>
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Precio promedio NV Agrupado x Categoria</h3>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="tabla-data-consulta" data-page-length="25">
                    <thead>
                        <tr>
                            <th class="tooltipsC" title='Vendedor'>Vendedor</th>
                            <th class="tooltipsC" title='Nombre Grupo'>Nombre Grupo (Precio promedio)</th>
                            <th class='tooltipsC' style="text-align:right" title='Total $'>Total $</th>
                            <th class='tooltipsC' style="text-align:right" title='Total Kg'>Total Kg</th>
                            <th class='tooltipsC' style="text-align:right" title='Factura'>Promedio</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
