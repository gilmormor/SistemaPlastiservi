                            ...
                            @foreach($detalles as $detalle)
                                ...
                                <tr name="fila{{$aux_nfila}}" id="fila{{$aux_nfila}}" class="proditems">
                                                ...
                                                @foreach($invbodegaproductos as $invbodegaproducto)
                                                    @if ($invbodegaproducto->invbodega->sucursal_id == $data->sucursal_id)
                                                        <?php
                                                            ...
                                                            if($detalle->despachosoldet_invbodegaproducto->stock > 0 and $invbodegaproducto->invbodega->tipo == 1){
                                                                //$aux_stock = $arrayBodegasPicking[$invbodegaproducto->id . "-" . $detalle->id]["stock"];
                                                                $aux_stock = $detalle->despachosoldet_invbodegaproducto->stock;
                                    ...
                                    <td name="cla_nombreTD{{$aux_nfila}}" id="cla_nombreTD{{$aux_nfila}}">
                                        {{isset($detalle->notaventadetalle->producto->claseprod) ? $detalle->notaventadetalle->producto->claseprod->cla_nombre : ""}}
                                    </td>
                                    <td style="display:none;">
