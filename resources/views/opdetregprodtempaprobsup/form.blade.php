...
<div class="form-group col-xs-12 col-sm-2">
    <div class="row">
        <div class="form-group col-xs-12 col-sm-12">
            ...
            <input type="text" name="kgprod" id="kgprod" class="form-control" value="{{old('kgprod', number_format($opdet->kgprod, 2, ',', '.') ?? '')}}" valor={{$opdet->kgprod}} style="text-align:right;" readonly disabled/>
        </div>
        <div class="form-group col-xs-12 col-sm-12">
            <label for="saldokg" class="control-label" title="Kg Faltantes">Kg Faltantes</label>
            <input type="text" name="saldokg" id="saldokg" class="form-control" valor="{{$opdet->saldokg  ?? '0'}}" value="{{old('saldokg', number_format($opdet->saldokg, 2, ',', '.') ?? '')}}" style="text-align:right;" readonly disabled/>
        </div>
    </div>
</div>
<div class="form-group col-xs-12 col-sm-2">
