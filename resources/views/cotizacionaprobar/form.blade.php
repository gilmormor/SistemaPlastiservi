                    ...
                    <tbody>
                        @if ($aux_sta==2)
                            ...
                            @foreach($cotizacionDetalles as $CotizacionDetalle)
                                ...
                                <tr name="fila{{$aux_nfila}}" id="fila{{$aux_nfila}}" class="prod_id{{$CotizacionDetalle->producto_id}}">
                                    ...
                                    <td name="cotdet_atfirm{{$aux_nfila}}" id="cotdet_atfirm{{$aux_nfila}}">
                                        ...
                                        @else
                                            @if (isset($CotizacionDetalle->producto->acuerdotecnico->at_firmado))
                            ...
                            <tr id="trneto" name="trneto">
                                <td colspan="11" style="text-align:right"><b>Neto</b></td>
                                <td id="tdneto" name="tdneto" style="text-align:right">0,00</td>
                            </tr>
                            <tr id="triva" name="triva">
                                <td colspan="11" style="text-align:right"><b>IVA {{$tablas['empresa']->iva}}%</b></td>
