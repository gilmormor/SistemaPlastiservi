                ...
                <div class="box-body">
                    <div class="row">
                        <div id="group_oc_id" class="form-group col-xs-12 col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" name="oc_id" id="oc_id" class="form-control" value="{{old('oc_id', $data->oc_id ?? '')}}" placeholder="Nro Orden de Compra" maxlength="18" readonly disabled/>
                                <!--<span class="input-group-btn">
                        ...
                        @if ($aux_sta==2 or $aux_sta==3)
                            ...
                            @foreach($detalles as $detalle)
                                ...
                                <tr name="fila{{$aux_nfila}}" id="fila{{$aux_nfila}}" class="prod_id{{$detalle->producto_id}}">
                                    ...
                                    <td style="display:none;" name="diamextmmTD{{$aux_nfila}}" id="diamextmmTD{{$aux_nfila}}" style="text-align:right">
                                        {{$aux_ancho}}
                                    </td>
                                    <td style="display:none;">
                            ...
                            <tr id="triva" name="triva">
                                <td colspan="8" style="text-align:right"><b>IVA {{$empresa->iva}}%</b></td>
