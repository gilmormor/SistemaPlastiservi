    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary box-primary">
            ...
            <div class="table-responsive" id="tablaconsulta1">
                ...
                <div class="form-group col-xs-12 col-sm-2">
                    <label for="totalNVpenddesp" class="control-label" title="Notas de Venta pendiente de despacho">NV Pendientes</label>
            ...
            <div class="table-responsive" id="divbloqueopro">
                <div class="form-group col-xs-12 col-sm-12">
                    <label for="bloqueopro" class="control-label" title="Observación ingresada por Finanzas. El cliente está deshabilitado de forma manual y requiere habilitación o eliminación de la observación por parte de Finanzas.">Observación Financiera</label>
