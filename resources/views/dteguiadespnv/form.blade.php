    ...
    <div class="col-xs-12 col-sm-9">
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-3">
                ...
                <textarea class="form-control validar-texto-xml" name="obs" id="obs" value="{{old('obs', $data->obs ?? '')}}" placeholder="Observación" maxlength="90"></textarea>
            </div>
                    ...
                    <div class="row">
                        <div id="group_oc_id" class="form-group col-xs-12 col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" name="oc_id" id="oc_id" class="form-control validar-texto-xml" value="{{old('oc_id', $data->oc_id ?? '')}}" placeholder="Nro Orden de Compra" maxlength="18" {{!is_null($data->oc_id) ? "disabled readonly" : ""}}/>
                            </div>
                        </div>
                        ...
                        @foreach($detalles as $detalle)
                            <?php 
                                ...
                                if(isset($detalle->producto->acuerdotecnico)){
                                    ...
                                    $aux_cla_nombre = "";
                                    if(isset($detalle->producto->claseprod)){
                                        $aux_cla_nomb1 = $detalle->producto->claseprod->cla_descripcion;
                                        if(($aux_cla_nomb1 == "N/A" or $aux_cla_nomb1 == "SC")){
                                            $aux_cla_nombre = "";
                                        }else{
                                            $aux_cla_nombre = $aux_cla_nomb1;
                                        }
                                    }
