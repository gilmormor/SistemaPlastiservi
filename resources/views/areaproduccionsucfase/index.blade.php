...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/admin/indexnew.js")}}" type="text/javascript"></script>
    <script src="{{autoVer("assets/pages/scripts/areaproduccionsucfase/index.js")}}" type="text/javascript"></script>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            ...
            <div class="table-responsive">
                <table id='tabla-data-areaproduccionsucfase' name='tabla-data-areaproduccionsucfase' class='table display AllDataTables table-hover table-condensed tablascons' data-page-length='50'>
