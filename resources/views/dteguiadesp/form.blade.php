                                    ...
                                    <option
                                        ...
                                        @else
                                            ...
                                            @else
                                                ...
                                                @endif
                                            @endif --}}
                                            @if ($data->notaventa->centroeconomico_id==$centroeconomico->id)
                                                {{'selected'}}
                                            @endif
                                        @endif
                                ...
                                if(isset($dteguiadesp)){
                                    ...
                                    if(isset($producto->acuerdotecnico)){
                                        ...
                                        if(isset($producto->claseprod)){
                                            if(($producto->claseprod->cla_descripcion == "N/A" or $producto->claseprod->cla_descripcion == "SC")){
                                                $aux_cla_nombre = "";
                                            }else{
                                                $aux_cla_nombre = $producto->claseprod->cla_descripcion;
                                            }
                                        }
