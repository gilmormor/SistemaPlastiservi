    ...
    <div class="col-lg-12">
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Editar Guia Despacho # {{$dteguiadesp->id}}</h3>
            ...
            <form action="{{route('actualizar_dteguiadesp', ['id' => $dteguiadesp->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off">
                @csrf @method("put")
                <div class="box-body">
