...
<input type="hidden" name="tipodespacho" id="tipodespacho" value="2">
<input type="hidden" name="indtraslado" id="indtraslado" value="1">
...
<div class="row">
    <div class="col-xs-12 col-sm-9">
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-2">
                <label for="fchemis" class="control-label requerido" data-toggle='tooltip' title="Fecha Guia">Fec Guia</label>
            ...
            <div class="form-group col-xs-12 col-sm-2">
                <label for="nrodocto" class="control-label requerido">Nro. Guia</label>
