...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/dteguiadespdirantigua/index.js")}}" type="text/javascript"></script>
@endsection
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{route('crear_dteguiadespdirantigua')}}" class="btn btn-block btn-success btn-sm">
