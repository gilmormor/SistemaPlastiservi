...
@section("scripts")
    ...
    <script src="{{autoVer("assets/pages/scripts/cotizacionatfirmado/index.js")}}" type="text/javascript"></script>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Cotización - Subir AT firmado</h3>
            </div>
            <div class="box-body">
                    ...
                    <table class="table display AllDataTables table-condensed table-hover" id="tabla-data-cotizacion">
                        <thead>
                            <tr>
                                ...
                                <th class="width30" style="text-align: center;">Con Firma</th>
