                ...
                <div class="box-body">
                    <div class="row">
                        <div id="group_oc_id" class="form-group col-xs-12 col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" name="oc_id" id="oc_id" class="form-control validar-texto-xml" value="{{old('oc_id', $data->oc_id ?? '')}}" placeholder="Nro Orden de Compra" maxlength="18" {{$enableCamposCot}} {{$aux_inputRequerido}}/>
                            </div>
                        </div>
                        ...
                        @if ($aux_sta==2 or $aux_sta==3)
                            ...
                            @foreach($detalles as $detalle)
                                <?php $aux_nfila++;
                                    ...
                                    //dd(isset($detalle->cotizacion_id));
                                    if(isset($detalle->cotizacion_id)){
                                        $cotizaciondetalle_id = $detalle->id;    
                                    }else{
                                ...
                                <tr name="fila{{$aux_nfila}}" id="fila{{$aux_nfila}}" class="prod_id{{$detalle->producto_id}}">
                                    ...
                                    <td name="preciounitTD{{$aux_nfila}}" id="preciounitTD{{$aux_nfila}}" style="text-align:right"> 
                                        ...
                                        {!! precioUnitSinCostoInsumos($detalle->docinsumodets, $detalle->preciounit) !!}
                                    </td>
                                    <td style="text-align:right;display:none;"> 
