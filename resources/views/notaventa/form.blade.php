        ...
        <div class="box box-danger" style="margin-bottom: 0px;margin-top: 2px;">
            <div class="box-header with-border">
                ...
                -->
                            ...
                            <div class="input-group">
                                <input type="text" name="rut" id="rut" class="form-control" value="{{old('rut', $clienteselec[0]->rut ?? '')}}" onkeyup="llevarMayus(this);" title="F2 Buscar" placeholder="F2 Buscar"  maxlength="9" oninput="validarInputRut(event)" onkeyup="llevarMayus(this);" required {{$disabledReadOnly}} {{$disabledcliente}}/>
                                <span class="input-group-btn">
                                    @if (session('aux_aproNV')=='0')
