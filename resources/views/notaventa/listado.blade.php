...
<div id="page_pdf">
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					...
					<th class="textcenter" width="35px">UN</th>
	...
	<div class="round" style="padding-bottom: 0px;padding-top: 8px;margin-bottom: 3px;">
		<table id="factura_detalle">
			...
			<tr>
				<td colspan="5" class="textright" width="90%"><span><strong>IVA {{$notaventa->piva}}%</strong></span></td>
	...
	<div class="round1" style="padding-bottom: 0px;">
		...
		<table id="factura_detalle">
			...
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>Comuna: </strong></span></td>
			...
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>Contacto: </strong></span></td>
				<td class="textleft" width="50%"><span>{{$notaventa->contacto}}</span></td>
			</tr>
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>Contacto email: </strong></span></td>
				<td class="textleft" width="50%"><span>{{strtolower($notaventa->contactoemail)}}</span></td>
			</tr>
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>Contacto Teléfono: </strong></span></td>
				<td class="textleft" width="50%"><span>{{$notaventa->contactotelf}}</span></td>
			</tr>
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>Orden de Compra: </strong></span></td>
				<td class="textleft" width="50%"><span>{{$notaventa->oc_id}}</span></td>
			</tr>
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>No. Cotización: </strong></span></td>
				<td class="textleft" width="50%"><span>{{str_pad($notaventa->cotizacion_id, 10, "0", STR_PAD_LEFT)}}</span></td>
			</tr>
			<tr>
				<td colspan="5" class="textleft" width="40%"><span><strong>Pago a Nombre de: </strong></span></td>
