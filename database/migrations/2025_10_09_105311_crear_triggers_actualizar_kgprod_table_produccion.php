...
class CrearTriggersActualizarKgprodTableProduccion extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
            CREATE TRIGGER vtrg_kgprod_after_insert
        ...
        DB::unprepared('
            CREATE TRIGGER vtrg_kgprod_after_delete
        ...
        DB::unprepared('
            CREATE TRIGGER vtrg_kgprod_after_update
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS vtrg_kgprod_after_insert');
        DB::unprepared('DROP TRIGGER IF EXISTS vtrg_kgprod_after_delete');
        DB::unprepared('DROP TRIGGER IF EXISTS vtrg_kgprod_after_update');
    }
}