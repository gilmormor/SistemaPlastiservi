...
class CreateTableOpdetregprodtemp extends Migration
{
    ...
    public function up()
    {
        Schema::create('opdetregprodtemp', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('unidadmedida_id')->comment("Unidad de Medida.")->nullable();
            $table->foreign('unidadmedida_id','fk_opdetregprodtemp_unidadmedida')->references('id')->on('unidadmedida')->onDelete('restrict')->onUpdate('restrict');
